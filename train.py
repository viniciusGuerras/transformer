...
data_array = toke.encode(data_array[:10000],vocab_size)
...
model = Transformer(num_embeds, context_window, n_experts, top_k)
...
for iter in range(epochs):
    ...
    xb, yb = get_batch('train', current_context_window)
